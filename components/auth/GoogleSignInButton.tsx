  ...
  return (
    <View style={{ gap: 8 }}>
      <Pressable
        ...
        onPress={onPress}
        style={{ minHeight: 44, borderRadius: 12, backgroundColor: "#05070b", borderWidth: 1, borderColor: "rgba(255, 255, 255, 0.18)", alignItems: "center", justifyContent: "center", flexDirection: "row", gap: 10 }}
      >
      ...
      <Text style={{ color: theme.colors.textSecondary, fontSize: 12 }}>Google logo/auth exchange is ready for production wiring after client ID setup.</Text>
    </View>
  );
}
